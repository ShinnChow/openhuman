...
| `provider/auth.rs`                                                                | Provider auth-profile resolution shared across factory paths.                                                                                                                                                                                     |
| `temperature.rs`, `agent/tinyagents/thread_context.rs`                           | Per-workload temperature policy and ambient thread-context plumbing (`crates/openhuman-core/src/agent/tinyagents/`).                                                                                                                               |
