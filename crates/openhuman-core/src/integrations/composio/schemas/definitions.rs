//! [`schemas`]: the `ControllerSchema` definition for every `composio.*`
//! RPC method. Purely declarative — one big `match` from method name to its
//! namespace/description/inputs/outputs.
