//! `MemoryProvider`, `MemoryCore`, `MemoryRecall`, `MemoryPortability`, and
//! `MemoryIngest` forwarding for [`ModuleMemoryProvider`] — the central hub
//! trait and the family accessors it exposes.
