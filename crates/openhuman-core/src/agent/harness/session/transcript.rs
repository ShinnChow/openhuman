...
pub(crate) use metadata::{attach_tool_failure_metadata, attach_turn_usage_metadata};
pub use paths::{
...
#[cfg(test)]
use paths::{latest_in_dir, md_companion_path, next_index, raw_session_dir, sanitize_agent_name};
