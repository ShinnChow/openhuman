    ...
    fn frontend_rpc_catalog_path() -> PathBuf {
        PathBuf::from(env!("OPENHUMAN_REPOSITORY_ROOT")).join("app/src/services/rpcMethods.ts")
    }
    ...
    fn frontend_legacy_aliases_match_server_alias_table() {
        ...
        assert_eq!(
            ...
            "frontend LEGACY_METHOD_ALIASES must stay in sync with crates/openhuman-core/src/core/legacy_aliases.rs"
        );
    }
