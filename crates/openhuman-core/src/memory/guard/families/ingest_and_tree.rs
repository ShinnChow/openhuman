//! Guarded `Ingest`, `Documents`, and `Tree` — the families that write new
//! content into memory or read back its hierarchical tree structure.
//!
...
use crate::memory::api::provider::content::{
