//! Unicode normalization and the cheap byte-oriented candidate pre-filter
//! that gates which precise PII regexes run.
//!
//! Split out of `pii.rs`. [`NormalizedView`] defeats fullwidth-digit and
