...
//! half owns the PII replacement tokens, the normalization/candidate-scan
//! pipeline, the per-identifier regexes, and their checksum validators
//! (Luhn, IBAN mod-97, Verhoeff, Spanish DNI/NIE, ...); the generic
//! secret-pattern scrubber and [`Sanitized`]/[`SanitizationReport`] types
//! live in [`super::secrets`].
