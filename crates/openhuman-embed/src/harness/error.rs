...
pub enum HarnessError {
    ...
    /// domain subscribers are all process-scoped (see
    /// [`openhuman_core::core::runtime`]). Two harnesses would share those while
    /// believing they had separate workspaces, which corrupts state quietly
    /// rather than loudly. Failing here is the loud version.
    #[error(
